...
from cli_client.cli.media import PlaybackResult
from cli_client.cli.output import serialize_record
from cli_client.session import AggregatedReply, SessionState
...
def _execute(executor, action, reply_uuid="reply-1"):
    return executor.execute({"action": action, "params": {"reply_uuid": reply_uuid}})
