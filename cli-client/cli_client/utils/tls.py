"""TLS/CA helpers for CLI networking."""
...
def sanitize_tls_certificate_environment() -> None:
    ...
    variables. A stale path to a removed certificate file would otherwise
    make requests fail before it can use the default CA store.
    """
