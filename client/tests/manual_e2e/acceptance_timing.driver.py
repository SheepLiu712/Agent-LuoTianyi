...
Run from client/ after creating an isolated CLI auto-login file. Set
CLI_E2E_CREDENTIAL_FILE and CLI_E2E_IMAGE to override their default paths.
Results are written under client/temp/cli_acceptance_timing/.
"""
...
OUTPUT_DIR = CLIENT_DIR / "temp" / "cli_acceptance_timing"
