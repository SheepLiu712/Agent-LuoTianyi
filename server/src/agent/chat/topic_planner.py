...
from src.agent.chat.unread_store import UnreadMessage, UnreadStore, UnreadMessageSnapshot
from src.agent.chat.listen_timer import ListenTimer
import asyncio
...
class TopicPlanner:
    ...
    async def _extract_topics(self, unread_snapshot: UnreadMessageSnapshot, force_complete: bool) -> tuple[Optional[ExtractedTopic], List[UnreadMessage]]:
        ...
        try:
            ...
            topic, remaining = await self.system_runtime.agent.extract_topics_for_pipeline(
