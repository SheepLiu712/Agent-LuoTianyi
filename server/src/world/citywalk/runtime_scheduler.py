...
class CitywalkRuntimeService:
    def __init__(self, config: Dict[str, Any], vector_store: Any, llm_client: Any | None = None):
    ...
    def run_once(self) -> Optional[str]:
        ...
        environment_engine = CitywalkEnvironmentEngine(cfg, llm_client=self.llm_client)
        runner = CitywalkSessionRunner(cfg, client, environment_engine=environment_engine, llm_client=self.llm_client)
        ...
        ingestor = CitywalkMemoryIngestor(cfg, self.vector_store, llm_client=self.llm_client)
