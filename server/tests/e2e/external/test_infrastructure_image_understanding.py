"""Image-understanding infrastructure integration tests."""
...
def image_understanding(full_config):
    ...
    capability = ImageUnderstanding(full_config["infrastructure"]["image_understanding"])
    capability.create_vlm_module(llm_service)
    return capability


def test_vlm_config_is_valid(full_config):
    infrastructure_cfg = full_config.get("infrastructure", {})
    image_cfg = infrastructure_cfg.get("image_understanding", {})
