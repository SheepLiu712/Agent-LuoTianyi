...
const SCENES := {
	...
	"res://scenes/ui/model_page.tscn": {
		"root":"ModelPage","type":"Control","script":"res://src/ui/model_page.gd","setup":"setup",
		"unique":["Scroll","Cards","RefreshTypes","Status","PlainDialog","TestDialog"],
		"properties":{"Margin/Scroll":{"horizontal_scroll_mode":ScrollContainer.SCROLL_MODE_DISABLED},"Margin/Scroll/Column/Title":{"text":"LLM 模型设置"}},
	},
	"res://scenes/ui/model_purpose_card.tscn": {
		"root":"ModelPurposeCard","type":"PanelContainer","script":"res://src/ui/model_purpose_card.gd","setup":"setup",
		"unique":["PurposeTitle","Enabled","Requirements","Description","Fields","provider","base_url","api_key","ModelName","Json","Thinking","Params","CopySlot","CopyButton","TestButton","CardStatus"],
		"properties":{"Column/Fields/api_key":{"secret":true},"Column/Fields":{"visible":false},"Column/Header/Enabled":{"text":"使用自己的 API Key"}},
	},
