...
$groups = @{
    ...
    'run_feature_tests.py' = @('application/test_extension_contracts.gd', 'application/test_account_lifecycle.gd', 'test_preferences.gd', 'ui/test_unified_settings.gd', 'ui/test_model_cards.gd', 'ui/test_settings_control_states.gd', 'ui/test_logout_confirmation.gd', 'test_application_drafts.gd', 'test_model_settings.gd', 'test_model_execution.gd')
